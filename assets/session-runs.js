...
window.LM_SESSION_RUNS = [
  ...
  },
  {
    ...
    explore: "Pixels, features, and diffusion — and how to test hypotheses about visual defaults when a prompt leaves details open.",
    ...
    steps: [
      ...
      { time: "10–17", segment: "Pixels & features",
        move: "Open the Squint Test. Raise detail slowly and keep recognition distinct from generation.",
      ...
      { time: "17–25", segment: "The room's default",
        move: "Collect first-picture descriptions for “a doctor,” tally visible conventions, then use authored teaching simulations to rehearse how the room's hypothesis could be tested.",
        action: "Name what each simulated scene illustrates, what remains unknown, and which documented real outputs would be needed for a model-level claim.",
      ...
      { time: "44–52", segment: "Whose picture?",
        move: "Build a contribution map: user decisions, system operations, and hidden people or institutions.",
        action: "Name one credit, consent, or disclosure decision.",
      ...
      { time: "90–120", segment: "Guest spotlight, Q&A & close",
        ...
        action: "Track one visible human decision and one hidden system decision; ask questions and leave with one practice to carry forward.",
        tools: [] }
    ]
  },
  {
