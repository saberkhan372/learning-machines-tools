...
window.LM_SESSION_RUNS = [
  ...
  },
  {
    ...
    steps: [
      { time: "0–5", segment: "Welcome",
        move: "Repeat the recording / likeness boundary and camera-off, chat-only, or watch-only choices. Put the three-line argument on screen: fluent is not necessarily true; plausible is not necessarily neutral; smooth is not evidence.",
        action: "Choose a participation route and name the modality that still feels least settled.",
        tools: [] },
      { time: "5–12", segment: "Two artifact shares",
        move: "Invite two pre-arranged participants. Give each about three minutes: artifact, claim, boundary.",
        action: "Listen for the evidence behind each claim.",
        tools: [] },
      { time: "12–17", segment: "Active synthesis",
        move: "Retrieve rather than re-lecture. Match one prior activity to each of the three lines.",
        action: "Connect one Session 1 or 2 activity to the camp argument.",
        tools: [] },
      ...
      { time: "24–47", segment: "Temporal Telephone",
        move: "Build Run A with only the previous frame visible. Build Run B from the same first-frame anchor. Play and compare both saved runs, then name the analogy’s limit.",
        action: "Track one feature and state one observation plus one limit.",
        tools: [ { name: "Temporal Telephone", path: "tools/temporal-telephone/" } ] },
      { time: "47–57", segment: "Curated failure hunt",
        move: "Use two frozen examples. Track one feature at a time and mark the first exact break without inferring a universal architecture.",
        action: "Name identity drift, physics break, camera inconsistency, style drift, text corruption, or temporal jump precisely.",
        tools: [
      ...
      { time: "57–65", segment: "System map",
        move: "Map model, interface, training data, workers, prompter, subject, editor, and platform. Keep consent and provenance as separate questions.",
        action: "Name one human decision, one hidden contribution, one consent question, and one provenance question.",
        tools: [ { name: "AI Use + Consent Checklist", path: "worksheets/ai-use-consent-checklist/", worksheet: true } ] },
      { time: "65–83", segment: "One-tool studio",
        move: "Offer default and advanced routes. Require one Video Test Report row before a second tool; give a five-minute warning at 78.",
        action: "Finish one observation, one claim, and one boundary.",
        tools: [
      ...
      { time: "83–88", segment: "Two claims",
        move: "Invite two concise shares. Ask what evidence supports each claim and where its boundary lies.",
