  ...
  },
  {
    ...
    steps: [
      ...
      { time: "17–25", segment: "The room's default",
        move: "Collect first-picture descriptions for “a doctor,” tally visible conventions, then compare the room's hypothesis with several frozen outputs.",
        action: "Name what repeated, what was missing, and what evidence would justify a model-level claim.",
      ...
      { time: "60–90", segment: "Student work studio",
        ...
        action: "Complete one Image Default Test Board row, then post one evidence-based claim and next test.",
        tools: [
