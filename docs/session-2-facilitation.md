---
layout: page
title: "Session 2 Facilitation: Images"
---

# Session 2 Facilitation: Images
...
> **Need the words to say and detailed contingencies?** Open the evidence-informed
> [Session 2 Live Presenter Script](session-2-live-presenter-script.md). It adds
> the speakable transitions, safety notes, studio pathways, pacing flexes, and
> guest handoff behind this run sheet.
...
| 52-60 min | Mechanism debrief and studio launch | Synthesize the loop and launch pathways. | Share one evidence-based claim. |
| 60-90 min | Student work studio | Protect 25 minutes for investigation and five for posting. | Complete one observation and next test. |
| 90-120 min | Guest spotlight, Q&A, and close | Give the guest the full final block. | Track one visible and one hidden decision. |
