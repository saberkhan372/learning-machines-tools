...
1. **Experience the concept unplugged**
2. **See the mechanism**
3. **Choose a participation pathway**
4. **Run a structured investigation**
5. **Document evidence**
6. **Reflect ethically and creatively**
...
> Learning Machines: Text, Images, Video is a creative AI camp for investigating how generative systems actually work — serious enough for educators, artists, and researchers to bring real questions, and accessible enough that beginners can enter and skeptics can opt out of direct use. It is not a prompt-engineering workshop. Across three core sessions, we explore how generative AI systems create text, images, and video. Participants experiment with prompts, compare outputs, investigate model defaults and failures, and reflect on the role of human judgment in AI-assisted creativity. An optional studio supports final artifacts, classroom activities, model-behavior investigations, explainers, and critiques. No coding or machine learning background required.

Short description:

> How do AI systems write, imagine, and generate motion? Learning Machines is a creative AI camp for investigating what generative systems are actually doing — serious enough for educators, artists, and researchers to bring real questions, accessible enough that beginners can enter and skeptics can opt out of direct use. Across three core sessions and an optional studio, participants test prompts, compare outputs, investigate defaults and failures, and may make a final project, classroom activity, explainer, or critique to share in a closing studio. No coding required.
